...
1. Please make sure there is no [open issue](https://github.com/gr2m/octokit-plugin-get-semantic-releases/issues?utf8=%E2%9C%93&q=is%3Aissue) yet.
...
```shell
git clone https://github.com/<your account name>/octokit-plugin-get-semantic-releases.git
cd octokit-plugin-get-semantic-releases
npm install
```
...
- Submit a pull request from your topic branch to the main branch on the `gr2m/octokit-plugin-get-semantic-releases` repository.
- Be sure to tag any issues your pull request is taking care of / contributing to. Adding "Closes #123" to a pull request description will automatically close the issue once the pull request is merged in.

## Testing a pull request from github repo locally:

You can install `octokit-plugin-get-semantic-releases` from each pull request. Replace `[PULL REQUEST NUMBER]`:

```
npm install https://github.pika.dev/gr2m/octokit-plugin-get-semantic-releases/pr/[PULL REQUEST NUMBER]
```

Once you are done testing, you can revert back to the default module `octokit-plugin-get-semantic-releases` from npm with `npm install octokit-plugin-get-semantic-releases`
